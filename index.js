...
app.get('/getinfo',(req,res)=>{
    ...
    //res.send(name)
    var datainfo=[];
    request1('https://api.nutritionix.com/v1_1/search/'+name+'?results=0:1&fields=*&appId=3261edf2&appKey=95e818f8bf3d4cb81832d2d72d38bfac',function(error,response,body){
